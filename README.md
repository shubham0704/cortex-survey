...
- **Descent** — click the macro window (or open the `#forest` deep-link) to drill from
  the cortex zoom into a procedural Cajal neuron forest; it also auto-loops. The
  cortex → forest hand-off is a through-dark fade.
